...
import { fetchMyBookings, cancelBooking } from "../../store/bookingsSlice.js";
...
import { ROUTES, BOOKING_STATUS } from "../../constants/index.js";
...
const MyBookings = () => {
  ...
  const [cancelId, setCancelId]     = useState(null); // booking id pending cancel confirm
